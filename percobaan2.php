  ...
  <div class="col justify-content-center">
    <div class="kotak">
      <div class="container">
        ...
        <h4 class="mt-3"><b>Bandul Fisis</b></h4>
        <h6 class="mb-5">Kode Percobaan: G2</h6>
        <h6><b>I. Tujuan Percobaan</b></h6>
        <p>Menentukan percepatan gravitasi bumi dengan menggunakan Bandul Fisis.</p>

        <h6><b>II. Peralatan Yang Digunakan</b></h6>
        <ol>
          <li>Bandul fisis dan perlengkapannya (1 set)</li>
          <li>Beban Setangkup (1 buah)</li>
          <li>Rollmeter (1 buah)</li>
          <li>Stopwatch (1 buah)</li>
        </ol>

        <h6><b>III. Teori</b></h6>
        <p>Sebuah batang homogen dan cakram pejal disusun seperti pada Gambar 4.2 dan diayun pada salah satu titik sehingga menjadi sebuah sistem bandul fisis. Besar periode pada sistem tersebut sesuai persamaan </p>
        <div class="row justify-content-center mb-4">
          <img src="http://localhost/fisdas/assets/img/modul2-1.png" width="80%" alt="">
        </div>
        <p>Untuk menghitung percepatan gravitasi bumi dapat digunakan persamaan berikut ini :</p>
        <div class="row justify-content-center mb-4">
            <img src="http://localhost/fisdas/assets/img/modul2-2.png" width="80%" alt="">
        </div>

        <h6><b>IV. Cara Melakukan Percobaan:</b></h6>
        <ol>
          <li>Letakkan beban pada suatu kedudukan tertentu dan cari pusat massa C untuk kedudukan tersebut. Perlu diingat letak C selalu berubah tergantung letak kedudukan beban.</li>
          <li>Gantung beban pada titik A dan ukur a1.</li>
          <li>Ayun batang dengan simpangan kecil, catat waktu untuk 6 kali getaran sempurna.</li>
          <li>Ambil titik lain (B) terhadap titik C sebagai titik gantung dan ukur a2. Ulangi langkah 1 – 3.</li>
          <li>Ulangi percobaan untuk pasangan titik A dan B yang berbeda (tanya asisten).</li>
        </ol>

        <h6><b>V. Tugas Untuk Laporan Resmi:</b></h6>
        <ol>
          <li>Hitung g untuk tiap pasang titik A dan B dengan persamaan (3) dan gunakan ralat perhitungan.</li>
          <li>Berdasarkan hitungan (a) tentukan g di Surabaya.</li>
          <li>Buat kesimpulan dari percobaan ini.</li>
        </ol>

        <h6><b>VI. Tugas Pendahuluan:</b></h6>
        <ol>
          <li>Buktikan persamaan (2) dan (3).</li>
          <li>Terangkan konsepnya bila bandul fisis uniform.</li>
        </ol>
      </div>
    </div>
  </div>
