  ...
  <div class="col justify-content-center">
    <div class="kotak">
      <div class="container">
        ...
        <h6 class="mb-5">Kode Percobaan: M7</h6>
        ...
        <p>Dalam percobaan ini untuk menentukan tegangan permukaan zat cair di gunakan permukaan kontak berupa cincin aluminium berjari-jari r. Karena cincin punya 2 permuka-an (luar dan dalam) yang kontak dengan zat cair maka:</p>
        <div class="row justify-content-center mb-4">
        ...
        <ol>
          ...
          <li>Cairan yang dicari tegangan permukaan () adalah : air, minyak tanah, alkohol, dan olie.</li>
