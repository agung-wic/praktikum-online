        ...
        <form>
            <div class="form-group">
                <input class="form-control" type="text" placeholder="NRP"
                    style="margin-top: 35px; background-color: white; border-top: 0; border-bottom: 1px solid #6a6a6a; border-left: 1px solid #6a6a6a; border-right: 0;">
            </div>
            <div class="form-group">
                <input class="form-control" type="password" placeholder="Password"
                    style="margin-top: 25px; background-color: white; border-top: 0; border-bottom: 1px solid #6a6a6a; border-left: 1px solid #6a6a6a; border-right: 0;">
            </div>
