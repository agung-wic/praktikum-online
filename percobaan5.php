      ...
      <div class="col justify-content-center">
        <div class="kotak">
          <div class="container">
            ...
            <h4 class="mt-3"><b>Fletchers Trolley</b></h4>
            <h6 class="mb-3">Kode Percobaan: M2</h6>
            <h6><b>I. Tujuan Percobaan</b></h6>
            <p>Menghitung gerak dengan percepatan uniform (konstan).</p>

            <h6><b>II. Peralatan Yang Digunakan</b></h6>
            <ol>
              <li>Fletchers Trolley (1 set)</li>
              <li>Holding magnet (1 set)</li>
              <li>Stop clock (1 buah)</li>
              <li>Small Contact Plate (1 buah)</li>
              <li>Power Supply tegangan rendah (1 buah)</li>
              <li>Morse key (1 buah)</li>
              <li>Kabel penghubung (8 buah 1 set)</li>
            </ol>

            <h6><b>III. Teori</b></h6>
            <p>Benda dikatakan bergerak apabila kedudukannya berubah terhadap acuan tertentu, dan perubahan tersebut terjadi setiap saat. Titik-titik yang berurutan yang dilalui oleh benda yang bergerak disebut sebagai lintasan. Gerak benda yang disebabkan oleh suatu gaya menyebabkan benda bergerak dipercepat tanpa kecepatan awal. Secara matematis dapat ditulis:</p>
            <div class="row justify-content-center mb-4">
              <img src="http://localhost/fisdas/assets/img/modul5-1.png" width="80%" alt="">
            </div>

            <h6><b>IV. Cara Melakukan Percobaan:</b></h6>
            <ol>
              <li>Untuk percobaan pertama susun rangkaian 1 Gambar 4.6 dan tanyakan asisten sebelum peralatan dihubungkan ke tegangan PLN.</li>
              <li>Catatlah waktu yang diperlukan untuk menempuh jarak antara A dan B atau S, dan ulangi sebanyak 5 kali.</li>
              <li>Untuk percobaan kedua susun rangkaian 2 Gambar 4.7. Tentukan jarak B – C atau S’ tetap dan atur penyangga bandul agar pada waktu kereta menyentuh small contact plate, beban telah disangga oleh penyangga.</li>
              <li>Catatlah waktu yang diperlukan (t’) untuk jarak S’ dengan jarak (S) yang berubah-ubah menurut langkah: 2, dan ulangi sebanyak 5 kali.</li>
              <li>Jarak A – B atau B – C (S atau S’) ditentukan asisten.</li>
            </ol>
            <div class="row justify-content-center mb-4">
              <img src="http://localhost/fisdas/assets/img/modul5-2.png" width="80%" alt="">
            </div>
            <div class="row justify-content-center mb-4">
              <img src="http://localhost/fisdas/assets/img/modul5-3.png" width="80%" alt="">
            </div>

            <h6><b>V. Tugas Untuk Laporan Resmi:</b></h6>
            <ol>
              <li>Hitung harga k dan a serta buatlah ralat pengukuran.</li>
              <li>Buat grafik S = f(t<sup>2</sup>) dan V = f(t), lalu tentukan harga k dan a, bandingkan dengan hasil dan pengukuran.</li>
              <li>Dari langkah nomer 4 dan 5 manakah yang lebih cepat. Jelaskan dengan konsep yang saudara ketahui.</li>
              <li>Buatlah kesimpulan dari percobaan ini.</li>
            </ol>

            <h6><b>VI. Tugas Pendahuluan:</b></h6>
            <ol>
              <li>Berdasarkan hukum apa percobaan ini?</li>
              <li>Jelaskan hingga diperoleh persamaan (6), (7), dan (8).</li>
              <li>Sebutkan dan terangkan macam-macam gerak lurus.</li>
              <li>Jelaskan apa yang dimaksud dengan kecepatan sisa.</li>
            </ol>
          </div>
        </div>
      </div>
