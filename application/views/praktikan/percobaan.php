      ...
      <?php if ($user['role_id'] == 1) { ?>
        ...
        <?php } else { ?>
          ...
          <div class="row justify-content-center" style="transform:scale(1.2)">
            ...
            <?php } else { ?> <button style="color:#bcaead;background-color:#bcaead;font-size: 300%;margin-bottom:5%;margin-top:10%" data-id="<?= $modul['modul'] ?>" class="btn fa fa-arrow-circle-up" disabled>
              </button>
            <?php } ?>
          </div>
          <div class="row justify-content-center" style="transform:scale(1.2)">
