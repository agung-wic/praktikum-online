              ...
              <div class="kotak" style="background-color: #bcaead;">
                ...
                <div class="row justify-content-center">
                  <?php if ($tombol_arah[0]['tombol_status'] == 1) { ?>
                    <button style="font-size: 300%;margin-bottom:3%;margin-top:10%" type="submit" data-tampil=<?= $t['data_tampil_output']; ?> data-kirim="<?= $tombol_arah[0]['tombol_kirim'] ?>" data-id="<?= $modul['modul'] ?>" class="param1 btn btn-dark fa fa-arrow-circle-up kirim1a">
                    </button>
                ...
                <div class="row justify-content-center">
                  <?php if ($tombol_arah[2]['tombol_status'] == 1) { ?>
                    <button style="font-size: 300%" type="submit" data-tampil=<?= $t['data_tampil_output']; ?> data-kirim="<?= $tombol_arah[2]['tombol_kirim'] ?>" data-id="<?= $modul['modul'] ?>" class="param1 btn btn-dark fa fa-arrow-circle-left kirim1a">
                    </button>
                  ...
                  <?php if ($tombol_arah[3]['tombol_status'] == 1) { ?>
                    <button style="font-size: 300%" type="submit" data-tampil=<?= $t['data_tampil_output']; ?> data-kirim="<?= $tombol_arah[3]['tombol_kirim'] ?>" data-id="<?= $modul['modul'] ?>" class="param1 btn btn-dark fa fa-arrow-circle-right kirim1a">
                    </button>
                ...
                <div class="row justify-content-center">
                  <?php if ($tombol_arah[1]['tombol_status'] == 1) { ?>
                    <button style="font-size: 300%;margin-top:3%;margin-bottom:20%" type="submit" data-tampil=<?= $t['data_tampil_output']; ?> data-kirim="<?= $tombol_arah[1]['tombol_kirim'] ?>" data-id="<?= $modul['modul'] ?>" class="param1 btn btn-dark fa fa-arrow-circle-down kirim1a">
                    </button>
                  <?php } else { ?> <button style="color:#bcaead;background-color:#bcaead;font-size: 300%;margin-bottom:3%;margin-top:10%" data-id="<?= $modul['modul'] ?>" class="btn fa fa-arrow-circle-up" disabled>
                    </button>
                  <?php } ?>
