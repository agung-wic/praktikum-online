    ...
    <div class="container-fluid">
        ...
        <div class="kotak">
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <h6 class="m-0 font-weight-bold "><?= $title . $nama_kelompok['no_kelompok']; ?></h6>
                    </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($kelompok as $k) : ?>
                                    <tr>
                                        ...
                                        <td><?= $k['name'] ?></td>
                                        <td>
                                            <a href="<?= base_url('modul/deleteanggotakelompok/' . $k['id']); ?>" class="badge badge-pill badge-danger" onclick="return confirm('Yakin?');"><i class="fas fa-fw fa-trash-alt"></i>Delete</a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
