<div class="container">
    ...
    <div class="row-lg justify-content-center my-3 text-center">
        <div class="col-lg">
            <i class="fas fa-fingerprint fa-5x" style="background:-webkit-gradient(linear-gradient(40deg, rgba(111,140,252,1) 8%, rgba(47,200,201,1) 100%)); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"></i>
        </div>
    </div>
