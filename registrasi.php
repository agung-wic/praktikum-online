        ...
        <form>
            <div class="form-group">
                <input class="form-control" type="text" placeholder="Email"
                    style="margin-top: 35px; background-color: white; border-top: 0px; border-bottom: 1px solid #6a6a6a; border-left: 1px solid #6a6a6a; border-right: 0px;">
            </div>
            <div class="form-group">
                <input class="form-control" type="text" placeholder="Nama"
                    style="margin-top: 25px; background-color: white; border-top: 0px; border-bottom: 1px solid #6a6a6a; border-left: 1px solid #6a6a6a; border-right: 0px;">
            </div>
            <div class="form-group">
